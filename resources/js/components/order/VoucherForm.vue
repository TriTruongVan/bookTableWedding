  ...
  >
    ...
    >
      ...
      <div class="p-6 border-b border-gray-100 dark:border-gray-700">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            <div
              class="w-10 h-10 bg-rose-100 dark:bg-rose-900/30 rounded-lg flex items-center justify-center"
            >
              <svg
          ...
          <div
            v-if="soBan >= 50"
            class="flex items-center gap-2 px-3 py-1.5 bg-green-100 dark:bg-green-900/30 rounded-lg"
          >
            <svg
      ...
      <div class="p-6">
        <MultiSelect
          ...
          :pt="{
            root: {
              class:
                'w-full border border-gray-200 dark:border-gray-600 rounded-xl focus-within:ring-2 focus-within:ring-blue-500 transition-all dark:bg-gray-700',
            },
            label: {
              class: 'px-4 py-3',
            },
          ...
          <template #option="{ option }">
            ...
            >
              <div class="flex items-start gap-3">
                <div
                  class="w-10 h-10 bg-gradient-to-br from-rose-500 to-pink-500 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm"
                >
                  <svg
                ...
                <div class="flex-1 min-w-0">
                  ...
                  >
                    ...
                    <span
                      >Áp dụng từ {{ option.conditions.min_tables }} bàn</span
                    >
                  </div>
                </div>
              </div>
        ...
        <div
          v-if="soBan < 50"
          class="mt-4 bg-amber-50 dark:bg-amber-900/20 rounded-xl p-4 border border-amber-200 dark:border-amber-900/30"
        >
          <div class="flex gap-3">
            <svg
              class="w-5 h-5 text-amber-600 dark:text-amber-500 flex-shrink-0 mt-0.5"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
              <path
            ...
            <div class="text-sm text-amber-800 dark:text-amber-300">
              ...
              <p class="mt-1">
                Vui lòng đặt từ 50 bàn trở lên để được áp dụng ưu đãi.
              </p>
            </div>
          </div>
        </div>
      ...
      <div v-if="voucherData.length > 0" class="px-6 pb-6">
        <div
          class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-4 border border-green-100 dark:border-green-900/30"
        >
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              <div
