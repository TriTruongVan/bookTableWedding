...
import { create } from '../../../services/staffService'
            ...
            <div class="p-6">
              <ul class="space-y-4">
                ...
                <li class="flex items-start gap-3">
                  ...
                  <span class="text-sm text-gray-700 dark:text-gray-300">
                    Loại Nhân viên: <span class="font-semibold">Phục vụ</span> hoặc <span class="font-semibold">Bếp</span>
                  </span>
                </li>
                <li class="flex items-start gap-3">
