...
<template>
  ...
  >
    <div class="max-w-7xl mx-auto">
      ...
      <div
        class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8 mb-6 animate-fade-in-down"
      >
        <div class="flex justify-between items-center">
          <div class="space-y-2">
            <div class="flex items-center gap-3">
              <div
                class="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center shadow-lg animate-pulse-slow"
              >
        ...
        <div class="mt-6 animate-fade-in">
          <div class="relative">
            ...
            >
              <i
                class="pi pi-search text-gray-400 transition-colors duration-300"
              ></i>
            </div>
            <AutoComplete
              v-model="searchQuery"
            ...
            >
              <template #option="{ option }">
                <div
                  class="p-3 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-all duration-200 transform hover:scale-[1.02]"
                >
                  <div class="font-medium text-gray-900 dark:text-white">
                    {{ option.name }}
                  </div>
                  <div
                    class="text-sm text-gray-600 dark:text-gray-300 mt-1 truncate"
                  >
      ...
      <div
        class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6 animate-fade-in-up animation-delay-100"
      >
      ...
      <!-- Table với animation -->
      <div
        class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden animate-fade-in-up animation-delay-200"
      >
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
          <div class="flex items-center gap-3">
            <div
              class="w-10 h-10 rounded-lg bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:rotate-12"
            >
        ...
        <div class="overflow-x-auto px-4 py-2">
          ...
          >
            <Column field="id" header="ID" style="min-width: 140px">
              <template #body="{ data }">
                <div
                  class="px-4 py-2.5 rounded-lg bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/30 dark:to-cyan-900/30 border-2 border-blue-200 dark:border-blue-700 shadow-sm transition-all duration-300 hover:shadow-md hover:scale-105 cursor-pointer"
                >
                  <span
            ...
            <Column field="name" header="Tên món ăn" style="min-width: 300px">
              <template #body="{ data }">
                <div
                  class="flex items-center gap-4 py-2 transition-all duration-300 hover:translate-x-2"
                >
                  <div class="flex-1 min-w-0">
                    <div
                      class="font-semibold text-gray-900 dark:text-white transition-colors duration-300 hover:text-indigo-600 dark:hover:text-indigo-400"
                    >
                      {{ data.name }}
                    </div>
                  </div>
            ...
            <Column header="Danh mục" style="min-width: 180px">
              <template #body="{ data }">
                <span
                  class="text-sm text-gray-600 dark:text-gray-300 line-clamp-2 transition-colors duration-300 hover:text-gray-900 dark:hover:text-white"
                >
