          ...
          <div class="flex items-center gap-3 flex-1">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Chỉnh sửa thông tin khách hàng trong hệ thống
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="p-6">
              <ul class="space-y-4">
                ...
                <li class="flex items-start gap-3">
                  ...
                  <span class="text-sm text-gray-700 dark:text-gray-300">
                    Nhấn <span class="font-semibold">"Cập nhật khách hàng"</span> để lưu thông tin
                  </span>
                </li>
                <li class="flex items-start gap-3">
          ...
          <div class="bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 rounded-2xl shadow-xl p-6 text-white">
            ...
            <div class="space-y-3">
              <div class="p-3 bg-white/10 backdrop-blur-sm rounded-lg">
                <div class="text-xs opacity-80 mb-1">Tên khách hàng</div>
                <div class="font-semibold truncate">{{ customer.name || '-' }}</div>
              </div>
              <div class="p-3 bg-white/10 backdrop-blur-sm rounded-lg">
                <div class="text-xs opacity-80 mb-1">Số điện thoại</div>
                <div class="font-semibold font-mono">{{ customer.tel || '-' }}</div>
              </div>
              <div class="p-3 bg-white/10 backdrop-blur-sm rounded-lg">
                <div class="text-xs opacity-80 mb-1">Loại khách hàng</div>
                <div class="font-semibold">
                  {{ customer.role === 1 ? 'Doanh nghiệp' : customer.role === 0 ? 'Cá nhân' : '-' }}
                </div>
              </div>
            </div>
          </div>
